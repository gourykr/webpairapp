...
import { AddcoordinatorPage } from '../addcoordinator/addcoordinator';
import { EditcoordinatorPage } from '../editcoordinator/editcoordinator';


/**
 * Generated class for the MarriagecoordinatorsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-marriagecoordinators',
  templateUrl: 'marriagecoordinators.html',
})
export class MarriagecoordinatorsPage {
...
userData = {"id": "","search":""};
 ...
 ionViewDidLoad() {
    ...
    this.remoteService.postData(this.userData,'getFranchiserlist').then((result) => {
  ...
  edituserdetails(id) {
  this.navCtrl.push(EditcoordinatorPage,{'id':id});
  }

  adduser(){
  this.navCtrl.push(AddcoordinatorPage);
  }
