...
/**
 * Generated class for the FregisterPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-fregister',
  templateUrl: 'fregister.html',
})
export class FregisterPage {
  createSuccess = false;
  loading: Loading;
  responseData : any;
  ...
  ionViewDidLoad() {
    ...
    console.log('ionViewDidLoad FregisterPage');
